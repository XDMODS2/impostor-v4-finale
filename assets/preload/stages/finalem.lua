...
function onCreatePost()
    ...
    makeAnimatedLuaSprite('flash', 'finale/finaleFlashback', -970, -150)
    ...
    makeAnimatedLuaSprite('blackIcon', 'icons/icon-blackFinale', getProperty('iconP2.x')+150, getProperty('iconP2.y')-75)
